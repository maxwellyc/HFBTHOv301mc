...
Module HFBTHO
  ...
  ! Frequent Constants
  ! MCedit ffdef65 for beta3 to octupole moment conversion
  Real(pr) :: PI,ffdef3,ffdef4,ffdef5,ffdef6,ffdef65,ffdef7
  ! Single constants
  ! MCedit r03 = r0^3
  ...
  Real(pr), Allocatable :: bet2_PES(:), bet4_PES(:), Q_PES(:,:)
